...
const PERKS = [
  { Icon: FiCreditCard,  text: 'Buy BT Points once — stake across all matches' },
      ...
      <div className="hidden lg:flex w-1/2 relative flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-white px-12 max-w-sm">
          ...
          <div className="bg-[#F5C518]/10 border border-[#F5C518]/25 rounded-xl p-4 mb-6">
            <p className="text-xs font-black text-[#F5C518] uppercase tracking-wide mb-2">How BT Points Work</p>
            <ul className="space-y-1.5">
              <li className="text-xs text-blue-200 leading-relaxed">Buy BT Points once using card or bank transfer</li>
              <li className="text-xs text-blue-200 leading-relaxed">Use points to stake on any prediction market</li>
              <li className="text-xs text-blue-200 leading-relaxed">Win more points — convert to cash at any time</li>
              <li className="text-xs text-blue-200 leading-relaxed">Admin sets the exchange rate (e.g. 100 BTP = $1)</li>
            </ul>
          </div>
